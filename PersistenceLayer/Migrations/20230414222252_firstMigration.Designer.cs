...
namespace PersistenceLayer.Migrations
{
    ...
    [Migration("20230414222252_firstMigration")]
            ...
            modelBuilder.Entity("QuestionUser", b =>
                {
                    ...
                    b.Property<int>("SaversForQuestionId")
                        .HasColumnType("int");

                    b.HasKey("SavedQuestionsId", "SaversForQuestionId");

                    b.HasIndex("SaversForQuestionId");
            ...
            modelBuilder.Entity("QuestionUser", b =>
                {
                    ...
                    b.HasOne("PersistenceLayer.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("SaversForQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
